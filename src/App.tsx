...
import Resume from "../public/SameerAhmadMir-GeneralProfessional-WxQw.pdf";
function App() {
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <a
              ...
              rel="noopener noreferrer" // Adds security to prevent malicious behavior
              download // Triggers the download
              onClick={(e) => {
                e.preventDefault();
                const link = document.createElement("a");
                link.href = Resume; // Replace with the actual path to your resume
                link.download = Resume; // Set your desired download file name
                link.click();
      ...
      <section id="statistics" className="py-20 bg-[#0f0f0f]">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center">
            <GitHubCalendar
              username="SaimMeEr" // Replace with your GitHub username
              colorScheme="dark"
              fontSize={16}
            />
          </div>
